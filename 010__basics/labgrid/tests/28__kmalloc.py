PROJECT = r"28__kmalloc"
MODULES = [r"kmalloc.ko"]
...
def test_070_logs_load(cmd):
    do_log_verification(cmd, ["mod_init(): called",
                              "mod_init(): *ptr1: ",
                              "mod_init(): *ptr1: 0xc00abcde",
                              "mod_init(): *ptr1: 0x00000000 - kzalloc()",
                              "mod_init(): *ptr1: 0xc0012345",
                              "mod_init(): ptr2->val 123, ptr2->data 'Humpty Dumpty sat on a wall.' (global data)",
                              "mod_exit(): called"])
