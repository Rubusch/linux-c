PROJECT = r"23__waitqueue-chardev"
MODULES = [r"waitqueue.ko"]
KERNELVERSION = r"6.6.21"
DEVNODE = "/dev/lothars_hello_class"
...
def test_070_logs_load(cmd):
    do_log_verification(cmd, ["waitqueue: loading out-of-tree module taints kernel.",
                                       "mod_init(): called",
                                       "mod_init(): thread created",
                                       "mod_init() done.",
                                       "waiting for event...",
                                       "hello_read()",
                                       "wait_routine(): event came from READ - read count: 1",
                                       "waiting for event...",
                                       "mod_exit(): called",
                                       "wait_routine(): event came from EXIT"])
