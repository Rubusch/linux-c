...
def test_080_logs(cmd):
    do_dmesg_verification(cmd, ["lothars_probe() - called",
                                "lothars_probe() - allocate device structure",
                                "lothars_probe() - init the wait queue head",
                                "lothars_probe() - get virtual int number from device",
                                "lothars_probe() - irq number '",
                                "lothars_probe() - done",
