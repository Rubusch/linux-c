...
struct kobj_attribute hello_sysfs_attr = __ATTR(hello_sysfs_value, 0600, sysfs_show, sysfs_store);
...
int init_hello_sysfs(void)
{
	...
	/* 2. Create sysfs file */
	if (sysfs_create_file(kobj_ref, (struct attribute*) &hello_sysfs_attr)) {
