...
def test_080_logs(cmd):
    do_dmesg_verification(cmd, ["init_hello_completion() started",
                                "init_hello_completion() - major = 237, minor = 0",
                                "kthread_create() successful",
                                "waiting for event...",
                                "event came from exit function",
                                "cleanup_hello_completion() READY."])
