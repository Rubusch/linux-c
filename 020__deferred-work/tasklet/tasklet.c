...
static const char tasklet_data[] = "The red brown fox jumps over...";

static void tasklet_function(struct tasklet_struct *unused)
{
	/*
	 * NB: Unnecessary ftrace-like logging - prefer using ftrace
	 */
	pr_info("%s(): called\n", __func__);
