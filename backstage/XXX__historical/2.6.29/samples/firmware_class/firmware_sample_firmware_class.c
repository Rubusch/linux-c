...
static inline struct class_device_attribute *
to_class_dev_attr(struct attribute *_attr)
{
...
static CLASS_DEVICE_ATTR(loading, 0644, firmware_loading_show,
				 ...
				 const char *fw_name, struct device *device)
{
	...
	retval =
		class_device_create_file(class_dev, &class_device_attr_loading);
	if (retval) {
