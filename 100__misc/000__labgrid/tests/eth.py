PROJECT = r"eth"
MODULES = ["eth-dummy.ko", "start.ko"]
MODARGS = 'PROBED_MODULE_NAME="lothars-eth-dummy"'
...
def test_080_logs(cmd):
    do_dmesg_verification(cmd, ["eth_dummy: loading out-of-tree module taints kernel.",
                                "eth_probe(): called",
